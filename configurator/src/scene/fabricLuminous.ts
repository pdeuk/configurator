...
export const GLOW_OPACITY = 0.08;
export const LUMINOUS_GLOW_OFFSET = 0.002;
export const LUMINOUS_EMISSIVE_INTENSITY = 0.09;
export const LUMINOUS_TRANSMISSION = 0.12;
export const PLAIN_LUMINOUS_EMISSIVE_INTENSITY = 0.11;
export const PLAIN_LUMINOUS_TRANSMISSION = 0.14;
export const LUMINOUS_ARTWORK_ROUGHNESS = 0.92;
export const LUMINOUS_PLAIN_ROUGHNESS = 0.94;
